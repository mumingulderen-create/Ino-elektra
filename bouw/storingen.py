...
STORINGEN = [
    ...
    },
    {
        ...
        "description": "Blijft je aardlekschakelaar eruit springen? Zo vind je zelf het apparaat dat de storing veroorzaakt. Lukt het niet: 24/7 elektricien in Utrecht, vaste prijs vooraf.",
    ...
    },
    {
        ...
        "description": "Stopcontact doet het niet meer, wordt warm, verkleurt of vonkt? Check deze punten en weet wanneer het gevaarlijk is. Elektricien in Utrecht met vaste prijs vooraf.",
